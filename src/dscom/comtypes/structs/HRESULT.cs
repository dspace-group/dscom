...
public struct HRESULT
{
    ...
    public const int TLBX_E_CANT_LOAD_MODULE = unchecked((int)0x801311A0);

    public const int TLBX_E_CANT_LOAD_CLASS = unchecked((int)0x801311A1);

    public const int TLBX_E_NULL_MODULE = unchecked((int)0x801311A2);

    public const int TLBX_E_NO_CLSID_KEY = unchecked((int)0x801311A3);

    public const int TLBX_E_CIRCULAR_EXPORT = unchecked((int)0x801311A4);

    public const int TLBX_E_CIRCULAR_IMPORT = unchecked((int)0x801311A5);

    public const int TLBX_E_BAD_NATIVETYPE = unchecked((int)0x801311A6);

    public const int TLBX_E_BAD_VTABLE = unchecked((int)0x801311A7);

    public const int TLBX_E_CRM_NON_STATIC = unchecked((int)0x801311A8);

    public const int TLBX_E_CRM_INVALID_SIG = unchecked((int)0x801311A9);

    public const int TLBX_E_CLASS_LOAD_EXCEPTION = unchecked((int)0x801311AA);

    public const int TLBX_E_UNKNOWN_SIGNATURE = unchecked((int)0x801311AB);

    public const int TLBX_E_REFERENCED_TYPELIB = unchecked((int)0x801311AC);

    public const int TLBX_S_REFERENCED_TYPELIB = unchecked(0x001311AC);

    public const int TLBX_E_INVALID_NAMESPACE = unchecked((int)0x801311AD);

    public const int TLBX_E_LAYOUT_ERROR = unchecked((int)0x801311AE);

    public const int TLBX_E_NOTIUNKNOWN = unchecked((int)0x801311AF);

    public const int TLBX_E_NONVISIBLEVALUECLASS = unchecked((int)0x801311B0);

    public const int TLBX_E_LPTSTR_NOT_ALLOWED = unchecked((int)0x801311B1);

    public const int TLBX_E_AUTO_CS_NOT_ALLOWED = unchecked((int)0x801311B2);

    public const int TLBX_S_NOSTDINTERFACE = unchecked(0x001311B3);

    public const int TLBX_S_DUPLICATE_DISPID = unchecked(0x001311B4);

    public const int TLBX_E_ENUM_VALUE_INVALID = unchecked((int)0x801311B5);

    public const int TLBX_E_DUPLICATE_IID = unchecked((int)0x801311B6);

    public const int TLBX_E_NO_NESTED_ARRAYS = unchecked((int)0x801311B7);

    public const int TLBX_E_PARAM_ERROR_NAMED = unchecked((int)0x801311B8);

    public const int TLBX_E_PARAM_ERROR_UNNAMED = unchecked((int)0x801311B9);

    public const int TLBX_E_AGNOST_SIGNATURE = unchecked((int)0x801311BA);

    public const int TLBX_E_CONVERT_FAIL = unchecked((int)0x801311BB);

    public const int TLBX_W_DUAL_NOT_DISPATCH = unchecked((int)0x801311BC);

    public const int TLBX_E_BAD_SIGNATURE = unchecked((int)0x801311BD);

    public const int TLBX_E_ARRAY_NEEDS_NT_FIXED = unchecked((int)0x801311BE);

    public const int TLBX_E_CLASS_NEEDS_NT_INTF = unchecked((int)0x801311BF);
    ...
    // public static readonly HRESULT E_PENDING = new(2147483658u);
    ...
    // public static readonly HRESULT REGDB_E_CLASSNOTREG = new(2147746132u);

    // public static readonly HRESULT DESTS_E_NO_MATCHING_ASSOC_HANDLER = new(2147749635u);

    // public static readonly HRESULT DESTS_E_NORECDOCS = new(2147749636u);

    // public static readonly HRESULT DESTS_E_NOTALLCLEARED = new(2147749637u);
    ...
    // public static readonly HRESULT INTSAFE_E_ARITHMETIC_OVERFLOW = new(2147942934u);
